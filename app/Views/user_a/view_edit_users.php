                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body ">
                            <form name="quickForm" id="quickForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button class="btn btn-primary float-right" onclick="searchUsers(event, this)">Search</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card-footer">
                            <p><?php echo $users_count ?> - records found with search filters</p>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($users))
                                        {
                                            ...
                                            foreach ($users as $user)
                                            {
                                                ...
                                                <tr>
                                                    <td><?php echo $sno++ ?></td>
                                                    <td><?php echo $helperModel->get_d_MM_Y_h_ia_from_date_string($user['created_on']) ?></td>
...
<script>
        ...
        $.ajax({
            ...
            success: function (response)
            {
                ...
                if (receivedData.success == 1)
                {
                    ...
                    $.each(receivedDataArray, function (idx, row)
                    {
                        $('[name="add_follow_up_modal"]').find('[name="name"]').text(row.user_name);
                        ...
                        $('[name="add_follow_up_modal"]').find('[name="user_id"]').val(row.user_id);
                    });
    ...
    function updateFollowUp(ev, e)
    {
        ...
        user_id = $('[name="add_follow_up_modal"]').find('[name="user_id"]').val();
        ...
        $.ajax({
            url: '<?php echo $custom_site_url . $controller; ?>/view_edit_users/add_follow_up',
            datatype: 'json',
            type: 'POST',
            data: submittedData,
            success: function (response)
    ...
    function viewFollowUp(user_id, e)
    {
        enableDisableDiv('#datatable', false);
        var submitData = {};
        submitData['user_id'] = user_id;
        ...
        $.ajax({
            url: '<?php echo $custom_site_url . $controller; ?>/ajax_request/user/follow_up',
            datatype: 'json',
            type: 'POST',
            data: submittedData,
            success: function (response)
    ...
    function searchUsers(ev, e)
    {
        ...
        $.ajax({
            url: '<?php echo $custom_site_url . $controller; ?>/view_edit_users/search',
            datatype: 'json',
            type: 'POST',
            data: submittedData,
            success: function (response)
