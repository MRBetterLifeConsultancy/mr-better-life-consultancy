...
class Home extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->controller_data['controller'] = HOME_URL;
    ...
    {
        $this->controller_data['controller_file_path'] = 'login_index';
        $this->controller_data['view_files_path'] = 'sign_in';
        $this->controller_data['menu_name'] = 'admin_login';
        $adminModel = new AdminModel();
        $adminModel->login($this->uri_segments, $this->controller_data);
    }
    ...
    public function login()
    {
        $this->controller_data['controller_file_path'] = 'user_index';
        $this->controller_data['view_files_path'] = 'user';
        $this->controller_data['menu_name'] = 'login';
        $userModel = new UserModel();
        $userModel->login($this->uri_segments, $this->controller_data);
    }
    ...
    public function register()
    {
        $this->controller_data['controller_file_path'] = 'user_index';
        $this->controller_data['view_files_path'] = 'user';
        $this->controller_data['menu_name'] = 'register';
        $homeModel = new HomeModel();
        $homeModel->register($this->uri_segments, $this->controller_data);
    }
